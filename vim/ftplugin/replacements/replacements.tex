...
\begin{table}<<VIM:INPUT|1|Optional Argument||[|]>>
    ...
    \begin{tabular}{<++>}
        <++>
    \end{tabular}
    \caption{<<VIM:INPUT|2|Name>>}<<VIM:INPUT|3|Label||\label{table-|}|>>
\end{table}<++>
...
::part::
\part<<VIM:CHOICE|1|With Number?|,*>>{<<VIM:INPUT|1|Title>>}<<VIM:INPUT|2|Label||\label{part-|}|>>
<++>

::chapter::
\chapter<<VIM:CHOICE|1|With Number?|,*>>{<<VIM:INPUT|1|Title>>}<<VIM:INPUT|2|Label||\label{chapter-|}|>>
<++>

::section::
\section<<VIM:CHOICE|1|With Number?|,*>>{<<VIM:INPUT|1|Title>>}<<VIM:INPUT|2|Label||\label{section-|}|>>
<++>

::subsection::
\subsection<<VIM:CHOICE|1|With Number?|,*>>{<<VIM:INPUT|1|Title>>}<<VIM:INPUT|2|Label||\label{subsection-|}|>>
<++>

::subsubsection::
\subsubsection<<VIM:CHOICE|1|With Number?|,*>>{<<VIM:INPUT|1|Title>>}<<VIM:INPUT|2|Label||\label{subsubsection-|}|>>
<++>

::paragraph::
\paragraph<<VIM:CHOICE|1|With Number?|,*>>{<<VIM:INPUT|1|Title>>}<<VIM:INPUT|2|Label||\label{paragraph-|}|>>
<++>

::subparagraph::
\subparagraph<<VIM:CHOICE|1|With Number?|,*>>{<<VIM:INPUT|1|Title>>}<<VIM:INPUT|2|Label||\label{subparagraph-|}|>>
<++>

::thm::
\begin{thm}<<VIM:INPUT|1|Optional Argument||[|]>><<VIM:INPUT|2|Label||\label{thm-|}|>>
    <++>
\end{thm}<++>

::prop::
\begin{prop}<<VIM:INPUT|1|Optional Argument||[|]>><<VIM:INPUT|2|Label||\label{prop-|}|>>
    <++>
\end{prop}<++>

::lem::
\begin{lem}<<VIM:INPUT|1|Optional Argument||[|]>><<VIM:INPUT|2|Label||\label{lem-|}|>>
    <++>
\end{lem}<++>

::cor::
\begin{cor}<<VIM:INPUT|1|Optional Argument||[|]>><<VIM:INPUT|2|Label||\label{cor-|}|>>
    <++>
\end{cor}<++>

::defn::
\begin{defn}<<VIM:INPUT|1|Optional Argument||[|]>><<VIM:INPUT|2|Label||\label{defn-|}|>>
    <++>
\end{defn}<++>

::ex::
\begin{ex}<<VIM:INPUT|1|Optional Argument||[|]>><<VIM:INPUT|2|Label||\label{ex-|}|>>
    <++>
\end{ex}<++>

::rmk::
\begin{rmk}<<VIM:INPUT|1|Optional Argument||[|]>><<VIM:INPUT|2|Label||\label{rmk-|}|>>
    <++>
\end{rmk}<++>

::label::
\label{<<VIM:INPUT|1|Category>>-<<VIM:INPUT|2|Name>>}<++>

::figure::
\begin{figure}<<VIM:INPUT|1|Optional Argument||[|]>>
    \centering
    <++>
    \caption{<<VIM:INPUT|1|Name>>}<<VIM:INPUT|2|Label||\label{figure-|}|>>
\end{figure}<++>
