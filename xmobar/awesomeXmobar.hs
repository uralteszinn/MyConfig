...
--Config { font = "xft:Times New Roman-8"
       ...
       , sepChar = "%"
       , alignSep = "}{"
       , template = "%wlan%<fc=black,#333333> </fc> %wlan0% <fc=black,#333333> </fc>}%bat%{<fc=black,#333333> </fc>%vol%<fc=black,#333333> </fc>%kbd%<fc=black,#333333> </fc> %date% "
       , commands = 
           [ Run Date "DATE %d %B %Y" "date" 600
